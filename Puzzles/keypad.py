def puzzle_keypad():
	...
	health = 100 #edit this to match ga,")#me health variable name
	print ("You've encountered a keypad which which is connected to a door") #edit this to cahnge introudction of puzzle 
	...
	return health
	print("Finally the door oepns, you step through and enter the next room that awaits") 
